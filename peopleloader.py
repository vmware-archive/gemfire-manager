...
if __name__ == '__main__':
   ...
   sslArgs = ['-Dgemfire.ssl-keystore=vagrant/trusted.keystore','-Dgemfire.ssl-keystore-password=passw0rd','-Dgemfire.ssl-truststore=vagrant/trusted.keystore','-Dgemfire.ssl-truststore-password=passw0rd','-Dgemfire.ssl-default-alias=self', '-Dgemfire.ssl-enabled-components=server','-Djavax.net.ssl.keyStoreType=JKS','-Djavax.net.ssl.trustStoreType=JKS']
